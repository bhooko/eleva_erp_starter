...
class PurchaseOrder(db.Model):
    ...
    stage_id = db.Column(db.Integer, db.ForeignKey("procurement_stage.id"), nullable=True)
    status = db.Column(db.String(50), nullable=False, default="Draft")
    material_status = db.Column(db.String(30), nullable=False, default="Pending")
    ...
    freight_value = db.Column(db.Float, nullable=True, default=0)
    discount_value = db.Column(db.Float, nullable=True, default=0)
...
class PurchaseOrderItem(db.Model):
    ...
    description = db.Column(db.String(255), nullable=True)
    specification = db.Column(db.Text, nullable=True)
    specification_locked = db.Column(db.Boolean, nullable=False, default=False)
    unit = db.Column(db.String(20), nullable=True)
    ...
    source_bom = db.relationship("BillOfMaterials", foreign_keys=[source_bom_id])
    source_bom_line = db.relationship("BOMItem", foreign_keys=[source_bom_line_id])
...
class InventoryReceipt(db.Model):
    ...
    inventory_posted_at = db.Column(db.DateTime, nullable=True)
